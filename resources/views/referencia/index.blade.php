...
<div class="bg-white " style="margin-top: 0px ; text-align: center; width:100% ; align-self: center; padding-bottom: 15px;">
   ...
   <span><label><b>Proveedor :</b> </label>
    ...
    <div  style="text-align: right; margin: 10px;">
      <a href="{{route('viewIndexProviderCompany')}}" style = "margin-bottom: 15px;" target=""><span class="btn btn-primary btn-right"><i class="fas fa-angle-double-right"></i> Continuar</span></a> </div>    
    </div> 
