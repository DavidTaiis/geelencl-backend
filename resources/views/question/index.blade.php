   ...
   <span><label><b>Nombre :</b> </label>
    ...
    <span><label><b>Estado :</b> </label>
      ...
      <div  style="text-align: left; margin: 10px;">
        <a href="{{route('viewIndexSection', $section->empresas_id)}}" style = "margin-bottom: 15px;" target=""><span class="btn btn-secondary btn-left"><i class="fas fa-angle-double-left"></i> Atrás</span></a> </div>    
    </div> 
    @endif
